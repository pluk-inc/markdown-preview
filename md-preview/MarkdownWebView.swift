...
final class TableContextMenuPresenter: NSObject {
    ...
    func present(in view: NSView) {
        ...
        let rowItem = NSMenuItem(title: NSLocalizedString("Row", comment: "Table context menu submenu"), action: nil, keyEquivalent: "")
        rowItem.submenu = rowMenu()
        menu.addItem(rowItem)

        let columnItem = NSMenuItem(title: NSLocalizedString("Column", comment: "Table context menu submenu"), action: nil, keyEquivalent: "")
    ...
    private func rowMenu() -> NSMenu {
        let menu = NSMenu(title: NSLocalizedString("Row", comment: "Table row context menu"))
        menu.autoenablesItems = false
    ...
    private func columnMenu() -> NSMenu {
        let menu = NSMenu(title: NSLocalizedString("Column", comment: "Table column context menu"))
        menu.autoenablesItems = false
...
enum ContentWidthSetting: String, CaseIterable {
    ...
    var title: String {
        switch self {
        case .normal: return NSLocalizedString("Normal", comment: "Content width setting")
        case .fullWidth: return NSLocalizedString("Full Width", comment: "Content width setting")
        }
    }
