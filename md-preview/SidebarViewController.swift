...
extension ProjectNavigatorView: NSMenuDelegate {
    ...
    func menuNeedsUpdate(_ menu: NSMenu) {
        ...
        menu.addItem(makeMenuItem(title: NSLocalizedString("Show in Finder", comment: "Context menu item"),
                                  symbol: "folder",
        ...
        if !node.isDirectory {
            ...
            menu.addItem(makeMenuItem(title: NSLocalizedString("Open in New Tab", comment: "Context menu item"),
                                      symbol: "macwindow",
                                      action: #selector(openInNewTab(_:)),
                                      url: url))
            menu.addItem(makeMenuItem(title: NSLocalizedString("Open in New Window", comment: "Context menu item"),
            ...
            menu.addItem(.separator())
            menu.addItem(makeMenuItem(title: NSLocalizedString("Copy", comment: "Context menu item"),
        ...
        menu.addItem(makeMenuItem(title: NSLocalizedString("Copy Path", comment: "Context menu item"),
